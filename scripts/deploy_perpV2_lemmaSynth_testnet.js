...
async function main() {
  ...
  collateral = new ethers.Contract(externalContracts.USDC, TestERC20Abi.abi, defaultSigner);
  ...
  console.log("xxETHLUSDL", xETHL.address);
  console.log("USDLeLemmaETHmma", await xETHL.usdl());
  await delay(10000);
