...
describe("xUSDL", function () {
  ...
  it("should revert while withdrawing & transfer before minimum lock", async function () {
    ...
    await expect(this.xusdl.withdraw(await balanceOf(this.xusdl, owner.address))).to.be.revertedWith(
      "xUSDL: Locked tokens",
    );
  });
  ...
  it("should revert while withdrawing & transfer before minimum lock when periphery contract deposits on behalf of an address", async function () {
    ...
    await expect(this.xusdl.connect(user1).withdraw(await balanceOf(this.xusdl, owner.address))).to.be.revertedWith(
      "xUSDL: Locked tokens",
    );
  });
  ...
  it("should withdraw & transfer after minimum lock", async function () {
    ...
    await expect(this.xusdl.withdraw(await balanceOf(this.xusdl, owner.address))).not.to.be.reverted;
  });
