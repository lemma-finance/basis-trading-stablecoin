...
contract USDLemmaOptimisticKovanTest is Test {
    Deploy public d;
    ...
    // Trying to reproduce TX 
    // https://kovan-optimistic.etherscan.io/tx/0x4d622d6b63c1c9ec978d7ff971753c53ff181d6cdd278ae9e789579f34b6db81
    function testOptKovanDepositToWExactCollateral1() public {
        _depositWExactCollateral(10000000000000000);
    }
